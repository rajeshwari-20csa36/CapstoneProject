package com.ust.zynctime.service;
...
public class EmployeeService {
    ...
    @Transactional
    public Employee addToTeam(Long id) {
        Employee employee = employeeRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Employee not found"));
        employee.setTeamMember(true);  // Set team member to true
        return employeeRepository.save(employee);
    }
    ...
    @Transactional
    public Employee removeFromTeam(Long id) {
        Employee employee = employeeRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Employee not found"));
        employee.setTeamMember(false);  // Set team member to false
        return employeeRepository.save(employee);
    }
